<script setup>
  const links = [
    ...
    { name: "CollegeShelf #3", link: "https://chat.whatsapp.com/G3eXbdL7mXYHHzYBBLSs6q", img: "/logo.webp" },
    ...
    { name: "Shelf Internships #1", link: "https://chat.whatsapp.com/FVZNWAsEUs89QB3qUwnkiy", img: "/links/shelf-book.webp" },
    { name: "Shelf Internships #2", link: "https://chat.whatsapp.com/IKz46xwjR8cKme0QSiutBi", img: "/links/shelf-book.webp" },
...
<style scoped>
    a {
        ...
        background: linear-gradient(90deg, #AE8941, #C5A250);
    }
    ...
    a:hover {
        background: linear-gradient(90deg, #c59b46, #eabf59);
    }
